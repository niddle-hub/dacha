...
static const VertexVector madhouse_vertices {//задаются координаты вершин
	/*{ -1., 0., 2.5 },//1
	{ 1., 0., 2.5 },//2
	{ -1., -1., 2. },//3
	{ -1., 1., 2. },//4
...
static const FaceVector madhouse_faces {//задаются грани: в скобках номера вершин
	/*{ 1, 4, 8, 9, 5 },
	{ 0, 2, 6, 7, 3 },
	{ 4, 3, 7, 8 },
	{ 2, 5, 9, 6 },
...
static const NormalVector madhouse_normals {//задаются координаты  нормали для граней, чтобы определить освещенность
	{ 1., 0., 0. },
	{ 1., 0., 0. },
	{ 1., 0., 0. },
...
static const TexCoordVector madhouse_tc {// координаты грани на текстуре
